...
// Writes sends response to client over tcp connection
...
// UnSubscribe removes current connection into subscribes of the given channel
...
// InMultiState tells is connection in an uncommited transaction
