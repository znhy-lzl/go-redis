...
// PutIfAbsent puts value if the key is not exist and returns the number of updated key-value
...
// Remove removes the key and returns the number of deleted key-value
...
// Keys returns all keys int dict
